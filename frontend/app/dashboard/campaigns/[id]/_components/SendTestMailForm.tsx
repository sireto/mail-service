...
const SendTestMailForm = ({
    ...
    return (
        <div className='bg-white rounded-md my-4 flex-1/2'>
            ...
            <form className='my-2 flex items-start justify-center gap-x-4 lg:flex-col lg:items-start lg:gap-y-4
            ' onSubmit={form.handleSubmit(onSubmit)}>
                <div className="w-full">
                    <Input placeholder="Enter email address" {...form.register("email")} />
