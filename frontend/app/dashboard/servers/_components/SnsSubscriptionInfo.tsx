  ...
  return (
    <div className="w-full mx-auto p-6 bg-accent text-accent-foreground rounded-lg shadow-lg my-8">
      ...
      <p className="text-sm text-muted-foreground">
        To enable email status tracking via our email service, subscribe the
        following endpoint in your <strong>AWS SNS Topic</strong> settings.
      </p>
      ...
      <ul className="text-sm list-disc pl-5 text-muted-foreground space-y-1">
        <li>
          Go to the <strong>AWS SNS Console</strong>.
        </li>
        <li>Select the SNS Topic you want to use.</li>
        <li>
          Click on <strong>Create Subscription</strong>.
        </li>
        <li>
          Choose <strong>HTTPS</strong> as the Protocol.
        </li>
        <li>Paste the copied URL in the Endpoint field.</li>
        <li>
          In the delivery policy section, Uncheck the{" "}
          <strong>Use the default delivery policy</strong> and Update the
          Content-Type to <strong>application/json</strong>.
        </li>
        <li>
          Click on <strong>Create Subscription</strong>.
        </li>
